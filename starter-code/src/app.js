...
class Soldier {
  ...
  attack() {
    return `this soldier's strength is ${this.strengthArg}`;
  }

  receiveDamage(damage) {
    console.log(`health before is ${this.healthArg}`);
    this.healthArg = this.healthArg - damage;
    console.log(`health after is ${this.healthArg}`);
  }
}

// Tests for Soldier
let elder = new Soldier(3, 4);
console.log(elder);
console.log(elder.attack());
console.log(elder.receiveDamage(2));
...
// Tests for Viking
let joao = new Viking ('joao',5,9);
console.log(joao); 
console.log(joao.name);
console.log(joao.strengthArg);
console.log(joao.attack());
console.log(joao.receiveDamage(3)); // test for damage
console.log(joao.receiveDamage(2)); // test for died in combat
